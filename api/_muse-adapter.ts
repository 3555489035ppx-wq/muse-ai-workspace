...
function runtimeEnvironment(): Record<string, string> {
  return {
    ...
    MUSE_SITE_TEXT_PROVIDER: process.env.MUSE_SITE_TEXT_PROVIDER ?? "",
    MUSE_SITE_TEXT_DISPLAY_NAME: process.env.MUSE_SITE_TEXT_DISPLAY_NAME ?? "",
    MUSE_SITE_TEXT_API_KEY: process.env.MUSE_SITE_TEXT_API_KEY ?? "",
    MUSE_SITE_TEXT_BASE_URL: process.env.MUSE_SITE_TEXT_BASE_URL ?? "",
    MUSE_SITE_TEXT_MODEL: process.env.MUSE_SITE_TEXT_MODEL ?? "",
